...
```
![2fe86f2278fbfe84223540c3406ca5e1.png](../../_resources/4a3089813ec34936aa16614592baef4e.png)

Netcat
```plaintext
kali@kali:~/gitWorkspace/pwk/oscpExercises/7_activeGathering$ nc -nvv -w 1 -z 10.11.1.223 3388-3390
```
![9671c2795c447512233e181c8e2e4222.png](../../_resources/64d2c9ca7867424ca2a86c1e29c29e9d.png)
...
```
![ac60d38f8dc88234151a341b35242803.png](../../_resources/4ae7c15b5603466b9a01057a74ccf9ef.png)

Netcat
```plaintext
kali@kali:~/gitWorkspace/pwk/oscpExercises/7_activeGathering$ nc -nv -u -z -w 1 10.11.1.223 160-162
```
![4ff74c1464205bb3af581893ac92916c.png](../../_resources/e8bc15e57d3542dfbc1c694a7e32751a.png)
...
```
![e9d067fa623e1b7bb2d1edaedd8ac976.png](../../_resources/f3dee9a832f141878718e7c3090ae16f.png)

TCP SYN scan
```
kali@kali:~/gitWorkspace/pwk/oscpExercises/7_activeGathering$ sudo nmap -sS -p 21-25 10.11.1.14
```
![505b12d0a64be103cb44f92c66005c32.png](../../_resources/11397f41b78d43379e028ed8806be859.png)
